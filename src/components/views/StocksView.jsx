...
import { Award, BookOpen, Sparkles, CircleCheck, CircleAlert } from 'lucide-react';
...
function PrioriteBadge({ p }) {
  ...
  return (
    <div
      className="inline-flex items-center gap-2 px-3 py-1 text-xs uppercase tracking-[0.1em] font-medium"
      style={{
        color: config.color,
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-7">
          <Card padding="p-0" className="overflow-hidden sticky top-6">
            <div className="p-8" style={{ backgroundColor: COLORS.navy, color: COLORS.paper }}>
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h2 className="text-4xl font-normal font-serif">{selected.nom}</h2>
            ...
            <div className="grid grid-cols-4 gap-px p-0" style={{ backgroundColor: COLORS.border }}>
              {[
                ...
                <div key={kpi.label} className="p-4" style={{ backgroundColor: COLORS.creamDark }}>
                  <div className="text-[10px] uppercase tracking-[0.15em]" style={{ color: COLORS.inkMid }}>
                    {kpi.label}
                  </div>
                  <div
                    className="text-xl font-light tabular-nums mt-1 font-serif"
            ...
            <div className="p-8 space-y-6">
              <div className="flex items-center gap-4 pb-6 border-b border-border">
                <Award className="w-8 h-8" style={{ color: COLORS.sand }} />
                <div className="flex-1">
                  <div className="text-[10px] uppercase tracking-[0.15em]" style={{ color: COLORS.inkLight }}>
                    Hausse consécutive du dividende
                  </div>
                  <div className="flex items-baseline gap-3 mt-1">
                    <span className="text-4xl font-light tabular-nums font-serif" style={{ color: COLORS.ink }}>
                ...
                <div className="text-right">
                  ...
                  <div className="text-2xl font-light tabular-nums mt-1 font-serif" style={{ color: COLORS.ink }}>
              ...
              <div className="p-5 border-l-4" style={{ borderColor: COLORS.sand, backgroundColor: COLORS.cream }}>
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <div className="text-[10px] uppercase tracking-[0.15em] font-medium" style={{ color: COLORS.inkLight }}>
                      Fourchette d'achat
                    </div>
                    <div className="text-xl font-light tabular-nums mt-1 font-serif" style={{ color: COLORS.sandDark }}>
